        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Phones_Programs_ProgramName",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CallerNumber = table.Column<string>(type: "nvarchar(15)", nullable: false),
                    CalleeNumber = table.Column<string>(type: "nvarchar(15)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Calls", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Calls_Phones_CalleeNumber",
                        column: x => x.CalleeNumber,
                        principalTable: "Phones",
                        principalColumn: "PhoneNumber",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Calls_Phones_CallerNumber",
                        column: x => x.CallerNumber,
                        principalTable: "Phones",
                        principalColumn: "PhoneNumber",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Clients_Phones_PhoneNumber",
                        column: x => x.PhoneNumber,
                        principalTable: "Phones",
                        principalColumn: "PhoneNumber",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillsCalls", x => new { x.BillsId, x.CallsId });
                    table.ForeignKey(
                        name: "FK_BillsCalls_Bills_BillsId",
                        column: x => x.BillsId,
                        principalTable: "Bills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BillsCalls_Calls_CallsId",
                        column: x => x.CallsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillsCalls_CallsId",
                table: "BillsCalls",
                column: "CallsId");

            migrationBuilder.CreateIndex(
                name: "IX_Calls_CalleeNumber",
                table: "Calls",
                column: "CalleeNumber");
